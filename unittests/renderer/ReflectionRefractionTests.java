...
public class ReflectionRefractionTests {
    ...
    public void twoSpheres() {
        ...
        scene.lights.add( //
                new SpotLight(new Color(1000, 600, 0), new Point3D(-100, -100, 500), new Vector(-1, -1, -2), 5d) //
    ...
    public void twoSpheresOnMirrors() {
        Camera camera = new Camera.CameraBuilder(new Point3D(0, 0, 10000), new Vector(0, 0, -1), new Vector(0, 1, 0)) //
                .setViewPlaneSize(2500, 2500).setDistance(10000)
                .build(); //

        scene = new Scene.SceneBuilder(scene).setAmbientLight(new AmbientLight(new Color(255, 255, 255), 0.1))
                .build();
    ...
    public void trianglesTransparentSphere() {
        ...
        scene = new Scene.SceneBuilder(scene).setAmbientLight(new AmbientLight(new Color(java.awt.Color.WHITE), 0.15))
                .build();
