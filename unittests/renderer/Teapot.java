 ...
 */
public class Teapot {
    private final Camera camera = new Camera.CameraBuilder(new Point3D(0, 0, -1000), new Vector(0, 0, 1), new Vector(0, 1, 0)) //
            .setDistance(1000).setViewPlaneSize(200, 200).build();
